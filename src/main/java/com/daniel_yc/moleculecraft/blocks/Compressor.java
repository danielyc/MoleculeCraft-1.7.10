package com.daniel_yc.moleculecraft.blocks;
...
public class Compressor extends BlockContainer
{
	...
	{
		this.blockIcon = iconregister.registerIcon(Reference.MOD_ID + ":CompressorSide");
		this.front = iconregister.registerIcon(this.isWorking ? Reference.MOD_ID + ":CompressorActive" : Reference.MOD_ID + ":CompressorInActive");
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9) {
		player.openGui(MoleculeCraft.instance, 0, world, x, y, z);
		return true;
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemstack){
		...
		if(itemstack.hasDisplayName()){
			((TileEntityCompressor) world.getTileEntity(x, y, z)).compressorName(itemstack.getDisplayName());
		}
